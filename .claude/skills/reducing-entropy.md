...
description: Manual-only skill for minimizing total codebase size. Only activate when explicitly requested by user. Measures success by final code amount, not effort. Bias toward deletion. Use when asked to "simplify", "reduce code", "clean up", "remove dead code", or "minimize".
---
